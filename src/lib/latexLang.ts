...
const latexHighlight = HighlightStyle.define([
  ...
  { tag: tags.keyword, color: "#0052ff", fontWeight: "600" },
  { tag: tags.string, color: "#d97706" },
  { tag: tags.bracket, color: "#003ecc" },
]);
...
const latexTheme = EditorView.theme({
  ...
  ".cm-content": { padding: "24px", caretColor: "#0052ff", color: "#374151" },
  ...
  ".cm-activeLine": { backgroundColor: "rgba(0, 82, 255, 0.04)" },
  ".cm-activeLineGutter": { backgroundColor: "rgba(0, 82, 255, 0.06)" },
  ".cm-cursor": { borderLeftColor: "#0052ff" },
  ".cm-selectionBackground": {
    backgroundColor: "rgba(0, 82, 255, 0.12) !important",
  },
  ".cm-focused .cm-selectionBackground": {
    backgroundColor: "rgba(0, 82, 255, 0.18) !important",
  },
